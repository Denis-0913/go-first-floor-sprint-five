...
func (w Walking) Calories() float64 {
	...
	heightInM := w.Height / float64(CmInM)
	meanSpeedMInS := w.meanSpeed() * KmHInMsec // СредняяСкоростьВМетрахВСекунду
...
func (s Swimming) TrainingInfo() InfoMessage {
	// вставьте ваш код ниже
	swimmnig := s.Training.TrainingInfo()
	swimmnig.Speed = s.meanSpeed()
	return swimmnig
}
